...
export default function FillChallenge({ challenge, onSubmit, disabled }) {
      ...
      <div className="rounded-2xl bg-slate-950 border border-slate-800 overflow-hidden shadow-inner">
        ...
        <div className="bg-slate-900/90 px-4 py-2.5 flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-mono text-slate-400 ml-2 flex items-center gap-1.5">
              <Code2 className="w-3.5 h-3.5 text-indigo-400" /> main.js
            </span>
          </div>
          <span className="text-[11px] font-mono text-slate-500 flex items-center gap-1">
            <Terminal className="w-3 h-3" /> JS Code Editor
          </span>
        </div>
        ...
        <div className="p-4 bg-slate-950">
          <textarea
            ...
            disabled={disabled}
            placeholder={challenge.placeholder || 'Type your code here...'}
            className="w-full bg-transparent font-mono text-sm text-indigo-200 focus:outline-none resize-none leading-relaxed placeholder:text-slate-700"
          />
        </div>
      </div>
